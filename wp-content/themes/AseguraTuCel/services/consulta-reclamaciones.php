<?php
  ...
  curl_setopt_array($curl, array(
    ...
    //CURLOPT_POSTFIELDS => "get_requirements=1&documento=".$params["documento"]."&linea=".$params["linea"],
    CURLOPT_POSTFIELDS => "APIKEY=yNPlsmOGgZoGmH$6&trazabilidadTickets=true&documento=".$params["documento"]."&linea=".$params["linea"],
