      ...
      $params = json_decode($request, true);
        ...
        curl_setopt_array($curl, array(
         // CURLOPT_URL => $URLGLOBAL,
          ...
          //CURLOPT_POSTFIELDS => "check_customer=1&documento=".$params["documento"]."&linea=".$params["linea"],
          CURLOPT_POSTFIELDS => "APIKEY=yNPlsmOGgZoGmH$6&verificaUsuarioCobertura=true&documento=".$params["documento"]."&linea=".$params["linea"],
